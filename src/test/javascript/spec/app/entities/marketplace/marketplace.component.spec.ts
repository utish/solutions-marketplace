...
import { MarketplaceComponent } from 'app/entities/marketplace/marketplace.component';
...
describe('Component Tests', () => {
    describe('Marketplace Management Component', () => {
        let comp: MarketplaceComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MarketplaceComponent, '')
                .compileComponents();
